...
namespace Teamon.Tools.Screenshooter
{
	...
	#if POLYGLOT
			screenshotName =
	 GetUniqueFilePath(screenSize.x, screenSize.y, false, true, Localization.Instance.SelectedLanguage.ToString(), outputFolder, "jpeg");
	#else
		...
		public static string GetUniqueFilePath(int width, int height, bool isSceneView, bool isUI, string lang,
